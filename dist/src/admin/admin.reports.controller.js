...
let AdminReportsController = class AdminReportsController {
    ...
    async transactions(page = '1', limit = '20', status) {
    ...
    async exportDaily(format = 'csv', res) {
...
__decorate([
    ...
    __metadata("design:returntype", Promise)
], AdminReportsController.prototype, "transactions", null);
__decorate([
    (0, common_1.Get)('export/daily'),
    ...
    __metadata("design:returntype", Promise)
], AdminReportsController.prototype, "exportDaily", null);
