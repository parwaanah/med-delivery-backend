    ...
    async create(receiverId, type, message, meta, senderId) {
        try {
            ...
            try {
                ...
                this.logger.warn(`WS push failed for user ${receiverId}`, err);
            }
            ...
            this.logger.error('create notification failed', err);
            throw err;
        }
    }
    async sendAdminToast(payload) {
        try {
            ...
            try {
                ...
                this.logger.warn('Failed to broadcast admin toast', err);
            }
        }
        catch (err) {
            this.logger.error('sendAdminToast failed', err);
        }
    }
