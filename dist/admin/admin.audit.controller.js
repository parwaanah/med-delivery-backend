...
let AdminAuditController = class AdminAuditController {
    ...
    async getAuditLogs(page = 1, limit = 25, userId, email, eventType, role, success) {
...
__decorate([
    ...
    __metadata("design:paramtypes", [Object, Object, Number, String, String, String, Boolean]),
    __metadata("design:returntype", Promise)
], AdminAuditController.prototype, "getAuditLogs", null);
__decorate([
    openapi.ApiOperation({ description: "Simple stats endpoint \u2014 total logins, fails, etc." }),
