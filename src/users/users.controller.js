...
var UsersController = function () {
    ...
    var UsersController = _classThis = /** @class */ (function () {
        ...
        UsersController_1.prototype.update = function (id, dto) {
    ...
    (function () {
        ...
        _findOne_decorators = [(0, common_1.Get)(':id'), (0, roles_decorator_1.Roles)('admin', 'pharmacy', 'rider', 'customer')];
        _update_decorators = [(0, common_1.Put)(':id'), (0, roles_decorator_1.Roles)('admin')];
